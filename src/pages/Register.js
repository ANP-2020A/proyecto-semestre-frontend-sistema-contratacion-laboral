...
const Register = () => {
    ...
    const onFinish = async (userData) => {
        ...
        const {name, email, password, password_confirmation,
            nombre, apellido,cedula,celular,provincia,genero,nacionalidad} = userData;
                ...
                <Col span={8}>
                    ...
                    >
                        ...
                        <Form.Item name='apellido'
                                   ...
                                   hasFeedback
                        >
                            <Input prefix={<EditOutlined/>} placeholder='Apellido'/>
                        </Form.Item>
                        ...
                        <Form.Item name='editorial'
                                   rules={[
                                       {
                                           required: true,
                                           message: 'Ingresa un nickname para tu cuenta'
                                       }
                                   ]}
                                   hasFeedback
                        >
                            <Input prefix={<EditOutlined/>} placeholder='Nickname'/>
                        </Form.Item>
                        ...
                        <Form.Item name='apellido'
                                   ...
                                   hasFeedback
                        >
                            <Input prefix={<EditOutlined/>} placeholder='Cedula'/>
                        </Form.Item>
                        ...
                        <Form.Item name='celular'
                                   ...
                                   hasFeedback
                        >
                            <Input prefix={<EditOutlined/>} placeholder='Celular'/>
                        </Form.Item>
                        <Form.Item name='provincia'
                                   rules={[
                                       {
                                           required: true,
                                           message: 'Ingresa tu provincia'
                                       }
                                   ]}
                                   hasFeedback
                        >
                            <Input prefix={<EditOutlined/>} placeholder='Provincia'/>
                        </Form.Item>
                        <Form.Item name='genero'
                                   rules={[
                                       {
                                           required: true,
                                           message: 'Ingresa tu genero'
                                       }
                                   ]}
                                   hasFeedback
                        >
                            <Input prefix={<EditOutlined/>} placeholder='Genero'/>
                        </Form.Item>
                        <Form.Item name='nacionalidad'
                                   rules={[
                                       {
                                           required: true,
                                   ...
                                   hasFeedback
                        >
                            <Input prefix={<EditOutlined/>} placeholder='Nacionalidad'/>
                        </Form.Item>
                        <Form.Item>
